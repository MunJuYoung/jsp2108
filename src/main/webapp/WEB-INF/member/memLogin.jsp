		...
		<div class="container" style="padding:20px;">
		  ...
		  <form name="myform" method="post" action="<%=request.getContextPath()%>/memLoginOk.mem" class="was-validated">
		    <div class="form-group">
		      ...
		      <input type="text" class="form-control" id="mid" placeholder="Enter username" name="mid" required autofocus>
		    ...
		    <button type="button" class="btn btn-primary">아이디/비밀번호찾기</button>
		  </form>
		</div>
	</div>
</div>
