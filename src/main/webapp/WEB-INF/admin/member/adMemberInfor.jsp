...
<div class="container">
  ...
  <table class = "table" >
  	...
  	<tr><td>포인트 : <fmt:formatNumber value="${vo.point}"></fmt:formatNumber></td></tr>
  	<tr>
  		<td>레벨 : 
  			<c:choose>
    		...
    		<c:otherwise><c:set var="level" value="준회원"/>${level}</c:otherwise>
    	</c:choose>
    	${level }
  		</td>
  	</tr>
  ...
  <%-- <a href="${ctp}/adMemberList.ad" target="_top">돌아가기</a> --%>
