...
SELECT * FROM insarok WHERE (buser = '영업과' and gender='남자') and (address='부산' or address='인천');
...
SELECT * FROM insarok WHERE gender='여자' and age BETWEEN 20 and 30;
...
-- 남자자료 처음부터 4건만 출력하시오?
SELECT * FROM insarok WHERE gender='남자' limit 0,5;


-- 남자자료 처음부터 4건을 나이 내림차순으로 출력하시오?
SELECT * FROM insarok WHERE gender='남자' ORDER BY age DESC limit 0,5;
...
UPDATE insarok SET jikwi='대리', netpay=netpay+500000 WHERE buser='영업과' and jikwi='사원';
